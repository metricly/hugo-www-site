...
This is why Metricly implemented [behavior learning](https://www.metricly.com/product/anomaly-detection) -- to minimize both alarm noise and the risk of unforeseen problems. Unlike static thresholds, Metricly's bands of normalcy conform to the "normal" behavior of your environment as determined by our behavior learning engine. Let's go back to those green and blue bands we saw previously:
