...
![Pick Perfect EC2 Instance: Choose Type](https://www.metricly.com/wp-content/uploads/2017/07/Choose-Instance-Type.png)
...
-   Which region the instance is hosted in.
    -   Whether the instances are [on-demand, spot, reserved or dedicated](https://www.metricly.com/demystifying-terminology-aws-instances).
...
[Elastic Load Balancing (ELB)](https://www.metricly.com/optimize-aws-route53-elb) allows you to distribute traffic between multiple instances and is priced based on an hourly rate, and on the amount of traffic which is transferred.
...
Measurement of capacity resource utilization over time is necessary for selection of the correct instance type and size for your application. While my approach above contained all the right elements, necessity requires a better and more efficient method. Let's begin by looking at Netuitive as an [AWS monitoring solution](https://www.metricly.com/getting-started-netuitive-aws), and taking the initial step in the process of gathering the required data.

I won't spend too much time on the setup and configuration of your Netuitive account, as that information is freely available in other articles on this site. If you are in need of an account, they offer a 21-day free trial that you can sign up for [here](https://www.metricly.com/signup). Additionally, you'll want to ensure that you [install the appropriate agent](https://www.metricly.com/integrations) on your instances depending on your operating system. Detailed installation instructions are provided for each respectively.
...
![Pick Perfect EC2 Instance: Cost By Tag](https://www.metricly.com/wp-content/uploads/2017/07/Costs-By-Tag-1024x479.png)
...
![Pick Perfect EC2 Instance: EC2 Recommendation](https://www.metricly.com/wp-content/uploads/2017/07/EC2-Recommendation.png)

This report was developed by the researchers at Netuitive as a means to display cost data, and offer [recommendations for AWS cost savings](https://www.metricly.com/optimize-aws-instance-types). The report also answers the all-important question "What EC2 instance type should I pick?"
...
![Pick Perfect EC2 Instance: Recommendation Graph](https://www.metricly.com/wp-content/uploads/2017/07/EC2-Recommendation-Graph-1024x459.png)
...
![Pick Perfect EC2 Instance: Recommendation Details](https://www.metricly.com/wp-content/uploads/2017/07/EC2-Reocmmendation-Details-1024x169.png)
