...
In this article, I’m going to introduce you to an important new offering from Metricly to improve [monitoring of your applications and services](https://www.metricly.com/monitoring), allow you to manage your environment better, and automate your monitoring strategies.

We’ll investigate [what checks are](https://www.metricly.com/introducing-system-checks), how to enable them, and then we’ll create a custom check and add it to a service. Finally, using that check and the data gathered from it, we’ll create an automated alert and notification for cases when the check fails.
...
Before you can create custom checks for your applications, you’ll need a Metricly account. (If you don’t already have an account,  [sign up for a 21-day free trial](https://www.metricly.com/signup).)
...
Installing the [Linux agent](https://www.metricly.com/support/integrations/linux) is very easy. Ensure that you have root access to your target device before you begin. Log in to your Metricly account and navigate to the Integration section of your account. Select the Linux Integration button.

![alert-img](https://www.metricly.com/wp-content/uploads/2018/03/The-Linux-Integration-e1520866534708.png)
...
```json
[et_pb_dmb_code_snippet admin_label=”Code Snippet” title=”HeartbeatCollector.conf”
style=”dark” linenums=”on” usetabwidth=”off” use_border_color=”off” border_color=”#ffffff”
border_style=”solid” header_font=”|on|||”]ZW5hYmxlZCA9IFRydWUKdHRsID0gMTUwCg==
...
```json
[et_pb_dmb_code_snippet admin_label=”Code Snippet” title=”Class for Dependent Resource
Check” style=”dark” linenums=”on” usetabwidth=”off” use_border_color=”off”
border_color=”#ffffff” border_style=”solid” header_font=”|on|||”][/et_pb_dmb_code_snippet]
```
...
```json
[et_pb_dmb_code_snippet admin_label=”Code Snippet” title=”Log Entries Generated by Custom Check”
style=”dark” linenums=”on” usetabwidth=”off” use_border_color=”off” border_color=”#ffffff”
border_style=”solid” header_font=”|on|||”][/et_pb_dmb_code_snippet]
```
...
A final note before we wrap it all up with our alert—If you encounter problems setting up your custom alert, consider [reaching out to Metricly support](https://support.metricly.com/hc/en-us/restricted?return_to=https%3A%2F%2Fsupport.metricly.com%2Fhc%2Fen-us). I don’t often have to contact them, but when I’ve needed assistance, I’ve found them to be very insightful and responsive.

#### Integrating the Custom Check into Your Metricly Account
We’ve already completed all the necessary work to integrate Custom Checks into our Metricly account. To view the checks, log in to your account and navigate to the [Inventory](https://app.metricly.com/#/inventory) page. You may need to add the n.checks column to your inventory table. You can do this by clicking on the settings button in the top right corner of the screen.

![alert-img](https://www.metricly.com/wp-content/uploads/2018/03/Including-the-n.checks-Column-1-e1520866819515.png)
...
![alert-img](https://www.metricly.com/wp-content/uploads/2018/03/Resource-with-Custom-Heartbeat-and-Port-Checks-Reporting-e1520866879425.png)
<!-- Resource with Custom, Heartbeat, and Port Checks Reporting -->

#### Automated Monitoring
Let’s add an alert to notify us when checks fail to report. We create an alert by defining a policy and assigning a notification to that policy when it fails. Navigate to the [Policies](https://app.metricly.com/#/policies) page, and click on the New Policy button.

![alert-img](https://www.metricly.com/wp-content/uploads/2018/03/New-Policy-Button-1-e1520866946171.png)
<!-- New Policy Button -->
...
![alert-img](https://www.metricly.com/wp-content/uploads/2018/03/Add-System-Check-Condition-1-e1520867013813.png)
<!-- Add System Check Condition -->

![alert-img](https://www.metricly.com/wp-content/uploads/2018/03/Custom-Check-Added-to-Policy-1-e1520867114349.png)
...
![alert-img](https://www.metricly.com/wp-content/uploads/2018/03/Configuring-an-Email-Notification-1-e1520867177287.png)
...
![alert-img](https://www.metricly.com/wp-content/uploads/2018/03/Email-from-a-Triggered-Alert-1.png)
...
In all of these ways, Metricly makes it simple to write and perform checks. Not yet using Metricly? [Signup for a free trial](https://www.metricly.com/signup) and get started!
